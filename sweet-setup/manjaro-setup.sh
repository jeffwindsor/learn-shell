...
source_dir="${HOME}/src"
###############################################################################
# inlined from src/includes/ascii-art/manjaro.sh
#
...
###############################################################################
# inlined from src/includes/manjaro/development-manjaro.sh

###############################################################################
# inlined from src/includes/manjaro/package-mgmt-manjaro.sh
...
###############################################################################
# inlined from src/includes/manjaro/preferences-manjaro.sh
function postinstall.set_manjaro_preferences(){
  # ? inputs for git global name & username ?
  # ? personalized arch/manjaro stuff needs to be added
  # ?   tweaks - left buttons, theme, background
  # ?   vm settings - power savings?
  # ?   start to document them here
}
###############################################################################
# inlined from src/includes/manjaro/vscode-manjaro.sh
function install.visual_studio_code(){
  # https://aur.archlinux.org/packages/visual-studio-code-bin
  add_package_aur visual-studio-code-bin
}
###############################################################################
